...
interface OrdenesCompraPorEstadoReportValues {
    fechaInicio: Date;
    fechaFin: Date;
    estado: string;
    totalOrdenes: number;
...
export const getOrdenesCompraPorEstadoReport = (
    values: OrdenesCompraPorEstadoReportValues,
): TDocumentDefinitions => {
    const { fechaInicio, fechaFin, estado, totalOrdenes, ordenes } = values;
    ...
    const docDefinition: TDocumentDefinitions = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    text: [
                        ...
                        {
                            text: 'REPORTE DE ÓRDENES DE COMPRA POR ESTADO',
                            fontSize: 10,
                        },
                    ],
                },
        ...
        content: [
            {
                text: `ÓRDENES DE COMPRA - ESTADO: ${getEstadoTexto(estado)}`,
                style: 'header',
