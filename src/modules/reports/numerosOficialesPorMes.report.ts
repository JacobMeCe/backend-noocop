...
export const getNumerosOficialesPorMesReport = (
    ...
    const tableBody: any[] = [
        [
            { text: 'Fecha', style: 'tableHeader', fillColor: '#800000' },
    ...
    fechasOrdenadas.forEach((fecha, index) => {
        ...
        if (index > 0) {
            tableBody.push([
                { text: '', colSpan: 7, border: [false, false, false, false], margin: [0, 3, 0, 3] },
                {},
                {},
                {},
                {},
        ...
        registros.forEach((n) => {
            tableBody.push([
                { text: DateFormatter.getDDMMYYYY(new Date(n.createdAt)), style: 'tableCell', alignment: 'center' },
